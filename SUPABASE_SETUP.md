...
팬페이지의 일정, 팬아트, 핫클립은 Supabase 공용 저장소에 저장됩니다. 그래서 한 사람이 올린 내용이 다른 사람에게도 보입니다.
...
- 모든 방문자가 같은 일정, 팬아트, 핫클립 목록을 봅니다.
- 새 일정 저장, 일정 삭제, 팬아트 추가, 팬아트 삭제, 핫클립 추가, 핫클립 삭제가 Supabase에 반영됩니다.
